...
{
       0,   119,   119,   122,   123,   124,   127,   128,   131,   132,
     135,   139,   140,   143,   144,   147,   148,   151,   152,   155,
     156,   157,   160,   161,   164,   165,   168,   169,   172,   175,
     176,   179,   180,   183,   184,   188,   189,   190,   191,   192,
     193,   194,   197,   198,   201,   202,   203,   204,   207,   208,
     211,   214,   215,   218,   219,   222,   223,   226,   229,   230,
     231,   232,   235,   236,   237,   238,   239,   242,   243,   246,
     247,   250,   251,   254,   255,   258,   259,   260,   261,   262,
     263,   266,   267,   270,   271,   274,   275,   278,   279,   282,
     283,   286,   287,   288,   291,   292,   295,   296,   297,   300,
     301,   304,   305,   308,   309,   310,   313,   316,   317,   320,
     321,   324,   325,   326,   327
};
#endif
...
#line 326 "parser.y" /* yacc.c:1646  */
    {(yyval.tree)=newExpNode(ConstantK,(yyvsp[0].tokenData)); (yyval.tree)->size = (yyvsp[0].tokenData)->nvalue + 1; (yyval.tree)->isArray = true; (yyval.tree)->attr.name = (yyvsp[0].tokenData)->svalue ; setType((yyval.tree),Char,false);}
#line 2115 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 114:
#line 327 "parser.y" /* yacc.c:1646  */
    {(yyval.tree)=newExpNode(ConstantK,(yyvsp[0].tokenData));setType((yyval.tree),Boolean,false);}
